    ...
    <div>
        ...
        <x-baseview title="Data Import">
            ...
            <div class="grid grid-cols-1 gap-6 mt-10 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div>
                    <x-settings-item title="Subcategories" wireClick="showImportDialog(5, 'Subcategories')">
                        <x-heroicon-o-folder class="w-5 h-5 mr-4" />
                    </x-settings-item>
                    <a href="{{ asset('xlxs/subcategories.xlsx') }}" download class="text-sm text-gray-500 underline">Download sample</a>
                </div>
